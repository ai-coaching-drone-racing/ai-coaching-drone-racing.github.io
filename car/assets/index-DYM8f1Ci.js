...
${q}`,[le,q]}function Gf(a){for(var o=a.length-2,u=a.length-1;u>=2&&a[u].optional;--u)o--;return o}function oa(a,o,u,f,v,M){var T=o.length;T<2&&xt("argTypes array size mismatch! Must at least get return value and 'this' types!"),P(!M,"Async bindings are only supported with JSPI.");for(var R=o[1]!==null&&u!==null,U=su(o),q=o[0].name!=="void",ee=T-2,le=Gf(o),he=[a,xt,f,v,Mo,o[0],o[1]],ue=0;ue<T-2;++ue)he.push(o[ue+2]);if(!U)for(var ue=R?1:2;ue<o.length;++ue)o[ue].destructorFunction!==null&&he.push(o[ue].destructorFunction);he.push(Vf,le,ee);let[me,$e]=Hf(o,R,q,M);var gt=new Function(...me,$e)(...he);return na(a,gt)}var ca=(a,o)=>{for(var u=[],f=0;f<a;f++)u.push(Ee[o+f*4>>2]);return u},Eo=a=>{a=a.trim();const o=a.indexOf("(");return o===-1?a:(P(a.endsWith(")"),"Parentheses for argument names should match."),a.slice(0,o))},Wf=(a,o,u,f,v,M,T,R,U)=>{var q=ca(u,f);o=Ht(o),o=Eo(o),M=ti(v,M,R),Gn([],[a],ee=>{ee=ee[0];var le=`${ee.name}.${o}`;function he(){nr(`Cannot call ${le} due to unbound types`,q)}o.startsWith("@@")&&(o=Symbol[o.substring(2)]);var ue=ee.registeredClass.constructor;return ue[o]===void 0?(he.argCount=u-1,ue[o]=he):(yo(ue,o,le),ue[o].overloadTable[u-1]=he),Gn([],q,me=>{var $e=[me[0],null].concat(me.slice(1)),gt=oa(le,$e,null,M,T,R);if(ue[o].overloadTable===void 0?(gt.argCount=u-1,ue[o]=gt):ue[o].overloadTable[u-1]=gt,ee.registeredClass.__derivedClasses)for(const at of ee.registeredClass.__derivedClasses)at.constructor.hasOwnProperty(o)||(at.constructor[o]=gt);return[]}),[]})},Xf=(a,o,u,f,v,M)=>{P(o>0);var T=ca(o,u);v=ti(f,v),Gn([],[a],R=>{R=R[0];var U=`constructor ${R.name}`;if(R.registeredClass.constructor_body===void 0&&(R.registeredClass.constructor_body=[]),R.registeredClass.constructor_body[o-1]!==void 0)throw new hs(`Cannot register multiple constructors with identical number of parameters (${o-1}) for class '${R.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);return R.registeredClass.constructor_body[o-1]=()=>{nr(`Cannot construct ${R.name} due to unbound types`,T)},Gn([],T,q=>(q.splice(1,0,null),R.registeredClass.constructor_body[o-1]=oa(U,q,null,v,M),[])),[]})},$f=(a,o,u,f,v,M,T,R,U,q)=>{var ee=ca(u,f);o=Ht(o),o=Eo(o),M=ti(v,M,U),Gn([],[a],le=>{le=le[0];var he=`${le.name}.${o}`;o.startsWith("@@")&&(o=Symbol[o.substring(2)]),R&&le.registeredClass.pureVirtualFunctions.push(o);function ue(){nr(`Cannot call ${he} due to unbound types`,ee)}var me=le.registeredClass.instancePrototype,$e=me[o];return $e===void 0||$e.overloadTable===void 0&&$e.className!==le.name&&$e.argCount===u-2?(ue.argCount=u-2,ue.className=le.name,me[o]=ue):(yo(me,o,he),me[o].overloadTable[u-2]=ue),Gn([],ee,gt=>{var at=oa(he,gt,le,M,T,U);return me[o].overloadTable===void 0?(at.argCount=u-2,me[o]=at):me[o].overloadTable[u-2]=at,[]}),[]})},au=(a,o,u)=>(a instanceof Object||xt(`${u} with invalid "this": ${a}`),a instanceof o.registeredClass.constructor||xt(`${u} incompatible with "this" of type ${a.constructor.name}`),a.$$.ptr||xt(`cannot call emscripten binding method ${u} on deleted object`),ia(a.$$.ptr,a.$$.ptrType.registeredClass,o.registeredClass)),jf=(a,o,u,f,v,M,T,R,U,q)=>{o=Ht(o),v=ti(f,v),Gn([],[a],ee=>{ee=ee[0];var le=`${ee.name}.${o}`,he={get(){nr(`Cannot access ${le} due to unbound types`,[u,T])},enumerable:!0,configurable:!0};return U?he.set=()=>nr(`Cannot access ${le} due to unbound types`,[u,T]):he.set=ue=>xt(le+" is a read-only property"),Object.defineProperty(ee.registeredClass.instancePrototype,o,he),Gn([],U?[u,T]:[u],ue=>{var me=ue[0],$e={get(){var at=au(this,ee,le+" getter");return me.fromWireType(v(M,at))},enumerable:!0};if(U){U=ti(R,U);var gt=ue[1];$e.set=function(at){var Ot=au(this,ee,le+" setter"),bt=[];U(q,Ot,gt.toWireType(bt,at)),Mo(bt)}}return Object.defineProperty(ee.registeredClass.instancePrototype,o,$e),[]}),[]})},qf=(a,o,u)=>{a=Ht(a),Gn([],[o],f=>(f=f[0],t[a]=f.fromWireType(u),[]))},ou=[],ni=[0,1,,1,null,1,!0,1,!1,1],bo=a=>{a>9&&--ni[a+1]===0&&(P(ni[a]!==void 0,"Decref for unallocated handle."),ni[a]=void 0,ou.push(a))},Qt={toValue:a=>(a||xt(`Cannot use deleted val. handle = ${a}`),P(a===2||ni[a]!==void 0&&a%2===0,`invalid handle: ${a}`),ni[a]),toHandle:a=>{switch(a){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:{const o=ou.pop()||ni.length;return ni[o]=a,ni[o+1]=1,o}}}},cu={name:"emscripten::val",fromWireType:a=>{var o=Qt.toValue(a);return bo(a),o},toWireType:(a,o)=>Qt.toHandle(o),argPackAdvance:ei,readValueFromPointer:ra,destructorFunction:null},lu=a=>Dn(a,cu),Yf=(a,o,u)=>{switch(o){case 1:return u?function(f){return this.fromWireType(et[f])}:function(f){return this.fromWireType(ut[f])};case 2:return u?function(f){return this.fromWireType(ce[f>>1])}:function(f){return this.fromWireType(ye[f>>1])};case 4:return u?function(f){return this.fromWireType(se[f>>2])}:function(f){return this.fromWireType(Ee[f>>2])};default:throw new TypeError(`invalid integer width (${o}): ${a}`)}},Kf=(a,o,u,f)=>{o=Ht(o);function v(){}v.values={},Dn(a,{name:o,constructor:v,fromWireType:function(M){return this.constructor.values[M]},toWireType:(M,T)=>T.value,argPackAdvance:ei,readValueFromPointer:Yf(o,u,f),destructorFunction:null}),So(o,v)},la=(a,o)=>{var u=er[a];return u===void 0&&xt(`${o} has unknown type ${ru(a)}`),u},Zf=(a,o,u)=>{var f=la(a,"enum");o=Ht(o);var v=f.constructor,M=Object.create(f.constructor.prototype,{value:{value:u},constructor:{value:na(`${f.name}_${o}`,function(){})}});v.values[u]=M,v[o]=M},Jf=(a,o)=>{switch(o){case 4:return function(u){return this.fromWireType(Xe[u>>2])};case 8:return function(u){return this.fromWireType(qe[u>>3])};default:throw new TypeError(`invalid float width (${o}): ${a}`)}},Qf=(a,o,u)=>{o=Ht(o),Dn(a,{name:o,fromWireType:f=>f,toWireType:(f,v)=>{if(typeof v!="number"&&typeof v!="boolean")throw new TypeError(`Cannot convert ${tr(v)} to ${this.name}`);return v},argPackAdvance:ei,readValueFromPointer:Jf(o,u),destructorFunction:null})},ep=(a,o,u,f,v,M,T,R)=>{var U=ca(o,u);a=Ht(a),a=Eo(a),v=ti(f,v,T),So(a,function(){nr(`Cannot call ${a} due to unbound types`,U)},o-1),Gn([],U,q=>{var ee=[q[0],null].concat(q.slice(1));return nu(a,oa(a,ee,null,v,M,T),o-1),[]})},tp=(a,o,u,f,v)=>{o=Ht(o);const M=f===0;let T=U=>U;if(M){var R=32-8*u;T=U=>U<<R>>>R,v=T(v)}Dn(a,{name:o,fromWireType:T,toWireType:(U,q)=>{if(typeof q!="number"&&typeof q!="boolean")throw new TypeError(`Cannot convert "${tr(q)}" to ${o}`);return Kl(o,q,f,v),q},argPackAdvance:ei,readValueFromPointer:Yl(o,u,f!==0),destructorFunction:null})},np=(a,o,u)=>{var f=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array],v=f[o];function M(T){var R=Ee[T>>2],U=Ee[T+4>>2];return new v(et.buffer,U,R)}u=Ht(u),Dn(a,{name:u,fromWireType:M,argPackAdvance:ei,readValueFromPointer:M},{ignoreDuplicateRegistrations:!0})},ip=Object.assign({optional:!0},cu),rp=(a,o)=>{Dn(a,ip)},ir=(a,o,u)=>(P(typeof u=="number","stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),re(a,ut,o,u)),sp=(a,o)=>{o=Ht(o),Dn(a,{name:o,fromWireType(u){for(var f=Ee[u>>2],v=u+4,M,T,R=v,T=0;T<=f;++T){var U=v+T;if(T==f||ut[U]==0){var q=U-R,ee=ct(R,q);M===void 0?M=ee:(M+="\0",M+=ee),R=U+1}}return ii(u),M},toWireType(u,f){f instanceof ArrayBuffer&&(f=new Uint8Array(f));var v,M=typeof f=="string";M||ArrayBuffer.isView(f)&&f.BYTES_PER_ELEMENT==1||xt("Cannot pass non-string to std::string"),M?v=j(f):v=f.length;var T=Ao(4+v+1),R=T+4;return Ee[T>>2]=v,M?ir(f,R,v+1):ut.set(f,R),u!==null&&u.push(ii,T),T},argPackAdvance:ei,readValueFromPointer:ra,destructorFunction(u){ii(u)}})},uu=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,ap=(a,o)=>{P(a%2==0,"Pointer passed to UTF16ToString must be aligned to two bytes!");for(var u=a>>1,f=u+o/2,v=u;!(v>=f)&&ye[v];)++v;if(v-u>16&&uu)return uu.decode(ye.subarray(u,v));for(var M="",T=u;!(T>=f);++T){var R=ye[T];if(R==0)break;M+=String.fromCharCode(R)}return M},op=(a,o,u)=>{if(P(o%2==0,"Pointer passed to stringToUTF16 must be aligned to two bytes!"),P(typeof u=="number","stringToUTF16(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),u??=2147483647,u<2)return 0;u-=2;for(var f=o,v=u<a.length*2?u/2:a.length,M=0;M<v;++M){var T=a.charCodeAt(M);ce[o>>1]=T,o+=2}return ce[o>>1]=0,o-f},cp=a=>a.length*2,lp=(a,o)=>{P(a%4==0,"Pointer passed to UTF32ToString must be aligned to four bytes!");for(var u="",f=0;!(f>=o/4);f++){var v=se[a+f*4>>2];if(!v)break;u+=String.fromCodePoint(v)}return u},up=(a,o,u)=>{if(P(o%4==0,"Pointer passed to stringToUTF32 must be aligned to four bytes!"),P(typeof u=="number","stringToUTF32(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),u??=2147483647,u<4)return 0;for(var f=o,v=f+u-4,M=0;M<a.length;++M){var T=a.codePointAt(M);if(T>65535&&M++,se[o>>2]=T,o+=4,o+4>v)break}return se[o>>2]=0,o-f},hp=a=>{for(var o=0,u=0;u<a.length;++u){var f=a.codePointAt(u);f>65535&&u++,o+=4}return o},dp=(a,o,u)=>{u=Ht(u);var f,v,M,T;o===2?(f=ap,v=op,T=cp,M=R=>ye[R>>1]):o===4&&(f=lp,v=up,T=hp,M=R=>Ee[R>>2]),Dn(a,{name:u,fromWireType:R=>{for(var U=Ee[R>>2],q,ee=R+4,le=0;le<=U;++le){var he=R+4+le*o;if(le==U||M(he)==0){var ue=he-ee,me=f(ee,ue);q===void 0?q=me:(q+="\0",q+=me),ee=he+o}}return ii(R),q},toWireType:(R,U)=>{typeof U!="string"&&xt(`Cannot pass non-string to C++ string type ${u}`);var q=T(U),ee=Ao(4+q+o);return Ee[ee>>2]=q/o,v(U,ee+4,q+o),R!==null&&R.push(ii,ee),ee},argPackAdvance:ei,readValueFromPointer:ra,destructorFunction(R){ii(R)}})},fp=(a,o)=>{lu(a)},pp=(a,o)=>{o=Ht(o),Dn(a,{isVoid:!0,name:o,argPackAdvance:0,fromWireType:()=>{},toWireType:(u,f)=>{}})},mp=()=>{throw new B},hu=(a,o,u)=>{var f=[],v=a.toWireType(f,u);return f.length&&(Ee[o>>2]=Qt.toHandle(f)),v},gp=(a,o,u)=>(a=Qt.toValue(a),o=la(o,"emval::as"),hu(o,u,a)),ua=[],_p=(a,o,u,f)=>(a=ua[a],o=Qt.toValue(o),a(null,o,u,f)),vp={},To=a=>{var o=vp[a];return o===void 0?Ht(a):o},xp=(a,o,u,f,v)=>(a=ua[a],o=Qt.toValue(o),u=To(u),a(o,o[u],f,v)),du=()=>globalThis,yp=a=>a===0?Qt.toHandle(du()):(a=To(a),Qt.toHandle(du()[a])),Sp=a=>{var o=ua.length;return ua.push(a),o},Mp=(a,o)=>{for(var u=new Array(a),f=0;f<a;++f)u[f]=la(Ee[o+f*4>>2],`parameter ${f}`);return u},Ep=(a,o,u)=>{var f=Mp(a,o),v=f.shift();a--;var M=`return function (obj, func, destructorsRef, args) {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ri,depthTest:!1,depthWrite:!1})}function Oh(){return new mi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:uo(),fragmentShader:`
		...
		`,blending:Ri,depthTest:!1,depthWrite:!1})}function kh(){return new mi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:uo(),fragmentShader:`
	...
	`}class Qd extends hi{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new Wd(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const ab={[vd]:"Linear",[xd]:"Reinhard",[yd]:"Cineon",[yl]:"ACESFilmic",[Md]:"AgX",[Ed]:"Neutral",[Sd]:"Custom"};function ob(r,e){const t=ab[e];return t===void 0?(Ge("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ha=new X;function cb(){yt.getLuminanceCoefficients(Ha);const r=Ha.x.toFixed(4),e=Ha.y.toFixed(4),t=Ha.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(ws).join(`
`)),c=fl(c),c=qh(c,t),c=Yh(c,t),l=fl(l),l=qh(l,t),l=Yh(l,t),c=Kh(c),l=Kh(l),t.isRawShaderMaterial!==!0&&(L=`#version 300 es
...
`)+`
`+x);const I=L+y+c,D=L+x+l,O=Xh(i,i.VERTEX_SHADER,I),P=Xh(i,i.FRAGMENT_SHADER,D);i.attachShader(w,O),i.attachShader(w,P),t.index0AttributeName!==void 0?i.bindAttribLocation(w,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(w,0,"position"),i.linkProgram(w);function V(B){if(r.debug.checkShaderErrors){const Y=i.getProgramInfoLog(w)||"",J=i.getShaderInfoLog(O)||"",K=i.getShaderInfoLog(P)||"",ie=Y.trim(),Z=J.trim(),te=K.trim();let pe=!0,_e=!0;if(i.getProgramParameter(w,i.LINK_STATUS)===!1)if(pe=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,w,O,P);else{const Ce=jh(i,O,"vertex"),Ne=jh(i,P,"fragment");Ye("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(w,i.VALIDATE_STATUS)+`
